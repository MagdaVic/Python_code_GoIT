...
def move_and_normalize_and_unarchieve_files_into_correct_folders(rootdir, dict_extentions, lst_all_files):
...
def remove_all_unnecessary_folders(rootdir):
    for it in os.scandir(rootdir):
...
def main():
    ...
    remove_all_unnecessary_folders(rootdir)
